...
wget -q -O - --post-data="DDDDD=${loginname}&upass=${passwd}&R1=0&R2=0&R3=0&R6=0&para=00&0MKKey=123456&buttonClicked=&redirect_url=&err_flag=&username=&password=&user=&cmd=&Login=&v6ip="\
"http://${loginhost}:801/eportal/?c=ACSetting&a=Login&protocol=http:&hostname=${loginhost}&iTermType=1&wlanuserip=${wlanuserip}&wlanacip=${wlanacip}&wlanacname=${wlanacname}&mac=00-00-00-00-00-00&ip=${wlanuserip}&enAdvert=0&queryACIP=0&loginMethod=1" \
